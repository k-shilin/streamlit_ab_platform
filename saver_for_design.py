...
def insert_into_cvm_ab(*, table_name: str, params_dict: dict) -> None:
    ...
    with connection.cursor() as cursor:
        for index, row in df.iterrows():
            ...
            query = f"INSERT INTO {table_name_dict[table_name]} ({columns}) VALUES ({values})"
...
def write_data_to_cvm_ab_design(*, design_params_dict: dict, return_exp_id:bool) -> None:
    ...
    if return_exp_id:
        return design_params_dict["experiment_id"]
